...
bot = random.choice(list(bots))
print('bot=', bot)
name = bots[bot]
print('name=', name)

# connect to reddit 
reddit = praw.Reddit(str(bot), user_agent='cs40')

# select a "home" submission in the /r/BotTown subreddit to post to,
# and put the url below
submission_url = 'https://old.reddit.com/r/BotTownJT/comments/r1nctp/test1/'
...
# fix following line
    ...
    for comment in all_comments:
        ...
        if str(comment.author) != str(name):
...
# have someone go comment on my reddit submission
    ...
    if has_not_commented:
        ...
        for comment in not_my_comments:
            ...
            for replies in comment.replies:
                if str(replies.author) == str(name):
                    did_reply = True
            if did_reply == False:
    ...
    submission = random.choice(list(reddit.subreddit("BotTownJT").hot(limit=5))) #praw website
    ...
    # python3 bot_counter.py --username=BOTterfly4
    #123 (122),50,50 (52)